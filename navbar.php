        ...
        <div class="menu-desplegablea">
            ...
            <div class="sesioa">
                <?php if (isset($_SESSION['id'])): ?>
                    <div class="sesioaHasi">
                        <!-- Erabiltzaile izena eta saioa itxi / fakturak -->
                        <img class="perfila" src="Argazkiak/perfila.png">
                        <p class="mensajeUsuario">Kaixo, <?= $_SESSION['izena'] ?>!</p>
                    </div>
                    <a href="itxiSaioa.php" class="menu-saioa">Itxi saioa</a>
                <?php else: ?>
                    <div class="sesioaHasi">
